...
calculate_frequencies.default <- function(original_values, valid_values) {
  ...
  out$set_total_valid_absolute_frequency(round(sum(table_valid_responses), 2)) #nolint
  out$set_total_valid_relative_frequency(round( #nolint
    (out$get_total_valid_absolute_frequency() / #nolint
